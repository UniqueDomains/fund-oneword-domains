# Available .FUND One-Word Domains (23,433)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-23%2C433%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **23,433 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 23,433 domains · **Median ask:** $19.02 · **High-demand under $2,500:** 2
...
| hot.fund  | premium   | $118.80   | $118.80       | medium         | medium | 3      | namesilo     |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 23,433 live domains                        |
...
> Unique Domains. *Available .FUND One-Word Domains*. Version 2026-09-15. Public GitHub extract for the exact Unique Domains search represented by this repository.
