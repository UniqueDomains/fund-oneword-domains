# Available .FUND One-Word Domains (21,258)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-21%2C258%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **21,258 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 21,258 domains · **Median ask:** $20.69 · **High-demand under $2,500:** 2
...
| --------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ------------------------------ |
| aba.fund  | available | $14.99    | $71.99        | high           | low    | 3      | namesilo                       |
| ceo.fund  | resell    | —         | —             | high           | low    | 3      | —                              |
| alp.fund  | premium   | $85.80    | $85.80        | high           | low    | 3      | namecheap                      |
| adh.fund  | available | $11.98    | $92.98        | high           | low    | 3      | namecheap                      |
| plz.fund  | resell    | —         | —             | high           | low    | 3      | HOSTINGER operations, UAB      |
...
| uuh.fund  | available | $14.99    | $71.99        | medium         | low    | 3      | namesilo                       |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 21,258 live domains                        |
...
> Unique Domains. *Available .FUND One-Word Domains*. Version 2026-09-26. Public GitHub extract for the exact Unique Domains search represented by this repository.
