# Available .FUND One-Word Domains (11,627)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-11%2C627%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **11,627 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 11,627 domains · **Median ask:** $27.58 · **High-demand under $2,500:** 0
...
| flower.fund       | resell    | —         | —             | 74             | 30     | 6      | Chengdu West Dimension Digital Technology Co., Ltd. |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 11,627 live domains                        |
...
This selection is entirely made up of one-word .fund domains. The set spans literal words, surnames, abstract terms, and more unusual picks such as shove.fund, adscript.fund, occasion.fund, and dracula.fund. That makes the range useful for both buyers seeking a direct finance signal and buyers willing to trade precision for memorability. When comparing these domains, start with semantic fit: a name like give.fund reads mission-led, while truffle.fund or roman.fund leans more distinctive than descriptive. Then check pricing discipline. The median ask is 27.58, so stronger names should justify any premium through clarity, recall, or category fit.

- All results are one-word names on the .fund extension
- Examples include give.fund, truffle.fund, and roman.fund
- Median ask is 27.58 across 11,620 listed domains
- Prioritize clarity, recall, and pricing fit when comparing
...
> Unique Domains. *Available .FUND One-Word Domains*. Version 2026-05-08. Public GitHub extract for the exact Unique Domains search represented by this repository.
